...
RouteResults <- c()
DistanceResults <- c()
DepartureTemperatureResults <- c()
DepartureVisabilityResults <- c()
DepartureWindSpeedResults <- c()
ArrivalTemperatureResults <- c()
ArrivalVisabilityResults <- c()
ArrivalWindSpeedResults <- c()
...
Year <- x2000
  ...
  source("Route.R")
  source("Distance.R")
  source("DepartureWeather.R")
  source("ArrivalWeather.R")
Year <- x2001
  source("Month.R")
  source("DayOfMonth.R")
  source("DayOfWeek.R")
...
rm(UniqueCarrier,FlightNumber,TailNumber,Origin,Destination,Route,Dataset,Year)
...
source("DepartureTemperatureCorrelation.R")
source("DepartureVisabilityCorrelation.R")
source("DepartureWindSpeedCorrelation.R")
source("ArrivalTemperatureCorrelation.R")
source("ArrivalVisabilityCorrelation.R")
source("ArrivalWindSpeedCorrelation.R")

#Output the results
Hypotheses <- c("Month","DayOfMonth","DayOfWeek","UniqueCarrier","FlightNumber","TailNumber","EstimatedElapsedTime","Origin","Destination","Route","Distance","DepartureTemperature","DepartureVisability","DepartureWindSpeed","ArrivalTemperature","ArrivalVisability","ArrivalWindSpeed")
Correlation <- c(MonthCorrelation,DayOfMonthCorrelation,DayOfWeekCorrelation,UniqueCarrierCorrelation,FlightNumberCorrelation,TailNumberCorrelation,EstimatedElapsedTimeCorrelation,OriginCorrelation,DestinationCorrelation,RouteCorrelation,DistanceCorrelation,DepartureTemperatureCorrelation,DepartureVisabilityCorrelation,DepartureWindSpeedCorrelation,ArrivalTemperatureCorrelation,ArrivalVisabilityCorrelation,ArrivalWindSpeedCorrelation)
Results <- data.frame(Hypotheses,Correlation)
write.csv(Results, file = "FlightInformationResults.csv")

#Remove unused variables
rm(MonthCorrelation,DayOfMonthCorrelation,DayOfWeekCorrelation,UniqueCarrierCorrelation,FlightNumberCorrelation,TailNumberCorrelation,EstimatedElapsedTimeCorrelation,OriginCorrelation,DestinationCorrelation,RouteCorrelation,DistanceCorrelation,DepartureTemperatureCorrelation,DepartureVisabilityCorrelation,DepartureWindSpeedCorrelation,ArrivalTemperatureCorrelation,ArrivalVisabilityCorrelation,ArrivalWindSpeedCorrelation)
rm(x2000,x2001,x2002,x2003,x2004,x2005,x2006,Hypotheses,Correlation,Results,WeatherDataset)
